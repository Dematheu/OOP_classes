...
class CarroLuxo(Veiculo):
    def buscar_cliente(self) -> None:
        print('Carro de luxo está indo buscar o cliente.')


class CarroPopular(Veiculo):
    def buscar_cliente(self) -> None:
        print('Carro de popular está indo buscar o cliente.')


class Moto(Veiculo):
    def buscar_cliente(self) -> None:
        print('Moto está indo buscar o cliente.')


class MotoLuxo(Veiculo):
    def buscar_cliente(self) -> None:
        print('Moto de luxo está indo buscar o cliente.')
