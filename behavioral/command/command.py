...
class Light:
    ...
    def on(self) -> None:
        print(f'{self.name} in {self.room_name} is ON.')

    def off(self) -> None:
        print(f'{self.name} in {self.room_name} is OFF.')
...
if __name__ == '__main__':
    bedroom_light = Light('Bed Light', 'bedroom')
    bathroom_light = Light('Bath Light', 'bathroom')
